...
module DuckySetUp
 ...
 def compile_reverse_meterpreter
   print_info("Creating Bin File!\n")
   system("java -jar duck_encoder/encoder.jar -i #{@@file_path}#{@@reverse_meterpreter_file} -o inject.bin")
   print_success("Bin File Created!\n")
 end
 def compile_hash_dump
   print_info("Creating Bin File!\n")
   system("java -jar duck_encoder/encoder.jar -i #{@@file_path}#{@@hash_dump_file} -o inject.bin")
   print_success("Bin File Created!\n")
 end
 def compile_lsass_dump
   print_info("Creating Bin File!\n")
   system("java -jar duck_encoder/encoder.jar -i #{@@file_path}#{@@lsass_dump_file} -o inject.bin")
   print_success("Bin File Created!\n")
 end
 def compile_wget
    print_info("Creating Bin File!\n")
    system("java -jar duck_encoder/encoder.jar -i #{@@file_path}#{@@wget_file} -o inject.bin")
    print_success("Bin File Created!\n")
 end
end
